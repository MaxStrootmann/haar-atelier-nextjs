...
const ContactPage = () => {
  ...
  return (
    <div className="px-4 py-8 md:px-8 lg:px-12 xl:px-24 max-w-screen-2xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row py-8 md:gap-24 lg:gap-48 mx-auto justify-center">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex pt-4 gap-1">
           <p>T:</p><a className="underline" href="tel: +31651126003">06 51126003</a>
          </div>
          <div className="flex gap-1">
           <p>E:</p><a className="underline" href="mailto:info@haaratelier-alkmaar.nl">info@haaratelier-alkmaar.nl</a>
          </div>
        </div>
      ...
      <div className="text-center text-sm md:text-base"><em>U kunt uw afspraak uitsluitend per telefoon of e-mail kosteloos wijzigen of annuleren binnen 48 uur voor aanvang van de afspraak, daarna zijn wij genoodzaakt 50% van de behandelprijs in rekening te brengen. Bij niet annuleren, dus “no show” moeten wij helaas het gehele bedrag in rekening brengen.</em></div>
