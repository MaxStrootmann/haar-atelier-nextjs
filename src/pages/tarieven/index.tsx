...
export default function Tarieven({ prices }: TarievenProps) {
 console.log("Recieved prices:", prices)
  return (
    <div className="text-center">
      <h1>Tarieven</h1>
      <p className="font-serif italic px-4 md:w-96 mx-auto py-8">Alle prijzen zijn vanafprijzen en zijn afhankelijk van de behandeling, lengte en dikte van het haar. Wanneer er meer verf/ tijd nodig is wordt er een toeslag gerekend.</p>
