        ...
        <div className="space-y-24 font-serif pb-40 px-8 pt-8 md:pt-60 -z-20">
          <div className="space-y-4">
            ...
            <p>
              ...
              middenin de binnenstad van Alkmaar. Loop binnen in de salon, of boek je afspraak eenvoudig online. Voel je
              welkom.
            </p>
            <p>Loop binnen in de salon, aan de Voordam. Of boek je afspraak eenvoudig online. Voel je welkom.</p>
          </div>
