      ...
      <div className='mt-24 text-center'>
        <div className='mb-8'>
          <a href='https://www.natulique.com/nl/'>
            <Image src={Icons.Logo_Natulique} alt={"Logo Natulique"} width={67 * 3} height={36 * 3} />
          </a>
        </div>
        <div className='flex flex-wrap justify-center items-center p-4'>
          <div className=' my-6 text-center w-26 h-18'>
            <Image src={Icons.Icon_Parabenes} alt='Icon Parabenes' width={58} height={58} />
            <p className='text-natulique text-[0.625rem] whitespace-nowrap'>Parebenes Free</p>
          </div>
          <div className=' my-6 text-center w-26 h-18'>
            <Image src={Icons.Icon_SLS} alt='Icon SLS' width={58} height={58} />
            <p className='text-natulique text-[0.625rem] whitespace-nowrap'>SLS Free</p>
          </div>
          <div className=' my-6 text-center w-26 h-18'>
            <Image src={Icons.Icon_Silicones} alt='Icon Silicones' width={58} height={58} />
            <p className='text-natulique text-[0.625rem] whitespace-nowrap'>Silicones Free*</p>
          </div>
          <div className=' my-6 text-center w-26 h-18'>
            <Image src={Icons.Icon_Phenoxyethanol} alt='Icon Phenoxyethanol' width={58} height={58} />
            <p className='text-natulique text-[0.625rem] whitespace-nowrap'>Phenoxyethanol Free</p>
          </div>
          <div className=' my-6 text-center w-26 h-18'>
            <Image src={Icons.Icon_Ammonia} alt='Icon Ammonia' width={58} height={58} />
            <p className='text-natulique text-[0.625rem] whitespace-nowrap'>Ammonia Free</p>
          </div>
          <div className=' my-6 text-center w-26 h-18'>
            <Image src={Icons.Icon_Fragrances} alt='Icon Fragrances' width={58} height={58} />
            <p className='text-natulique text-[0.625rem] whitespace-nowrap'>Artificial Fragrance Free</p>
          </div>
        </div>
        <div className='flex justify-center gap-24 mt-8'>
          <Image src={Icons.Icon_BIOCERT} alt={"360 Biocert Standard"} width={88} height={56} />
          <Image src={Icons.Icon_Vegan} alt={"Vegan"} width={88} height={72} />
        </div>
      </div>
      <div className='text-center mt-28 mx-16'>
        <Link href='/'>
          <Image src={haalogo} alt='Haar Atelier Alkmaar Logo' width={771 / 2} height={197 / 2}></Image>
        </Link>
        ...
        <IconContext.Provider value={{ size: "1.5rem" }}>
          ...
          <div className='mr-7'>
            <div className='flex justify-center items-center gap-2 mt-8'>
              ...
              <Link
                href={
                  "https://www.google.nl/maps/place/Voordam+10,+1811+MA+Alkmaar/@52.6318052,4.7485402,17z/data=!3m1!4b1!4m6!3m5!1s0x47cf57b4ffd45087:0x523807e1bf06d118!8m2!3d52.631802!4d4.7511151!16s%2Fg%2F11bw4r6r45?entry=ttu"
                }
            ...
            <div className='flex justify-center items-center gap-2 mt-8'>
              <p className='text-sm md:text-base'>Marloes</p>
              <BiPhone size={16} />
